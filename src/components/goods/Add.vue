<template>
    <div>
        ...
        <el-card>
            ...
            <el-form :model="addForm" label-width="100px" :rules="addFormRules" ref="addFormRef" label-position="top">
        ...
        <el-dialog title="图片预览" :visible.sync="previewVisible" width="50%" >
            <img :src="previewPath" class="previeImg">
        </el-dialog>
    </div>
</template>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            handleRemove(file) {
                const filePath = file.reponse.data.tmp_path;
